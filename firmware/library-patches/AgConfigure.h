...
public:
  ...
  int getPlantowerUploadIntervalSec(void);
  int getPlantowerPmReadIntervalSec(void);
  int getPlantowerWarmupSec(void);
  int getPlantowerUploadIntervalMs(void);
  int getPlantowerPmReadIntervalMs(void);
  int getPlantowerWarmupMs(void);
  String getPlantowerSensorMode(void);
  bool isPlantowerDutyCycleEnabled(void);
  bool setPlantowerLocalSettings(int uploadSec, int pmReadSec,
                                 String sensorMode, int warmupSec);
